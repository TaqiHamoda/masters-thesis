...
def visualize_sparse_pointcloud(dataset: Dataset, downsample_factor: int = 2) -> None:
    # Source: https://viser.studio/main/examples/demos/colmap_visualizer/

    images_path = dataset.image_dir
    colmap_path = Photogrammetry(dataset).sparse_path
